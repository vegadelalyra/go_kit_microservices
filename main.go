...
const dbsource = "postgresql://postgres:3335780@localhost:5432/postgres?sslmode=disable"

func main() {
	fmt.Println("~ GO KIT for MICROSERVICES ~")

	var httpAddr = flag.String("http", ":8080", "http listen addresss")
